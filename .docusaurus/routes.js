        ...
        routes: [
          {
            ...
            routes: [
              ...
              {
                path: '/docs/DevOps/gitOps/argocd/argocd使用',
                component: ComponentCreator('/docs/DevOps/gitOps/argocd/argocd使用', '1d8'),
                exact: true,
                sidebar: "DevOpsGitOps"
              },
              {
                path: '/docs/DevOps/gitOps/tekton/Tekton-catalog',
                component: ComponentCreator('/docs/DevOps/gitOps/tekton/Tekton-catalog', 'ce4'),
                exact: true,
                sidebar: "DevOpsGitOps"
              },
              {
                path: '/docs/DevOps/gitOps/tekton/tekton-results',
                component: ComponentCreator('/docs/DevOps/gitOps/tekton/tekton-results', 'ae8'),
                exact: true,
                sidebar: "DevOpsGitOps"
              },
              {
                path: '/docs/DevOps/gitOps/tekton/Tekton-sidecar',
                component: ComponentCreator('/docs/DevOps/gitOps/tekton/Tekton-sidecar', '022'),
                exact: true,
                sidebar: "DevOpsGitOps"
              },
              {
                path: '/docs/DevOps/gitOps/tekton/Tekton-triggers',
                component: ComponentCreator('/docs/DevOps/gitOps/tekton/Tekton-triggers', 'b09'),
                exact: true,
                sidebar: "DevOpsGitOps"
              },
              {
                path: '/docs/DevOps/gitOps/tekton/Tekton-workspace',
                component: ComponentCreator('/docs/DevOps/gitOps/tekton/Tekton-workspace', '900'),
                exact: true,
                sidebar: "DevOpsGitOps"
              },
              {
                path: '/docs/DevOps/gitOps/tekton/tekton安装',
                component: ComponentCreator('/docs/DevOps/gitOps/tekton/tekton安装', '684'),
                exact: true,
                sidebar: "DevOpsGitOps"
              },
              {
                path: '/docs/DevOps/gitOps/tekton/tekton拉取代码',
                component: ComponentCreator('/docs/DevOps/gitOps/tekton/tekton拉取代码', '243'),
                exact: true,
                sidebar: "DevOpsGitOps"
              },
              {
